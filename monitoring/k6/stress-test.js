...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:GET /api/reports/pdf}': ['p(95)<3000', 'p(99)<5000'], // PDF generation is slower
...
export function setup() {
  ...
  console.log(`[TEST START] Stress test started at: ${startTime}`);
...
export function teardown() {
  ...
  console.log(`[TEST END] Stress test completed at: ${endTime}`);
}
...
export default function () {
  ...
  if (shouldPerform(REQUEST_WEIGHTS.reportStats)) {
    ...
    let res = http.get(`${API_BASE}/reports/stats/current-user?daysBack=7`, { 
      headers,
  ...
  if (shouldPerform(REQUEST_WEIGHTS.reportPdf)) {
    ...
    let res = http.get(`${API_BASE}/reports/pdf?daysBack=7`, { 
      headers,
      tags: { name: 'GET /api/reports/pdf' },
    });
