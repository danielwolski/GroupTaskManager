...
// Tests all 3 microservices: auth-service, task-service, report-service
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:GET /api/reports/pdf}': ['p(95)<3000', 'p(99)<5000'],
...
export default function () {
  ...
  res = http.get(`${API_BASE}/reports/pdf?daysBack=7`, { 
    headers,
