...
// Tests monolithic backend application under normal load conditions
...
export function setup() {
  ...
  console.log(`[${startTime}] Test started: Load Test`);
...
export function teardown(data) {
  ...
  console.log(`[${endTime}] Test completed: Load Test`);
}
...
export default function () {
  ...
  if (isReportStatsSuccess) {
    ...
    logFailure('REPORT: GET /daily-tasks/stats/current-user', res);
  }
